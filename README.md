...
This is an easy contacts tracker app to explore Redux and compare this to the version made with the context api which can be found on the "contacts-react-context" repository.
